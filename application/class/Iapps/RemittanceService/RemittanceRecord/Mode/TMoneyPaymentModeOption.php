...
class TMoneyPaymentModeOption implements RemittancePaymentModeOptionInterface{
    ...
    public function getFormattedResponseMessage($response)
    {
        ...
        if(isset($response_arr['tmoney_response'])) {
            $response_arr = json_decode($response_arr['tmoney_response'], true);
            $response_arr['remarks'] = isset($response_arr["resultDesc"] ) ? $response_arr["resultDesc"]  : '';
        }        
        return $response_arr;
    }
