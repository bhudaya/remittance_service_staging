...
class RefundRequestAttributeValidation extends IappsValidator{

    protected $user_attribute;
    public static function make(RefundRequestAttribute $user_attr)
    {
        $v = new RefundRequestAttributeValidation();
