...
class RemittanceAttributeValidation extends IappsValidator{

    protected $user_attribute;
    public static function make(RemittanceAttribute $user_attr)
    {
        $v = new RemittanceAttributeValidation();
