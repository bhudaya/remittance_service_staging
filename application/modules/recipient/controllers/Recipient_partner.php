...
use Iapps\RemittanceService\Recipient\PartnerRecipientService;
use Iapps\Common\Core\IpAddress;

class Recipient_partner extends Partner_Base_Controller{
    ...
    function __construct()
    {
        ...
        $this->_recipient_serv = new PartnerRecipientService($repo);
    ...
    {
        if( !$adminId = $this->_getUserProfileId(FunctionCode::PARTNER_GET_REMITTANCE_TRANSACTION_DETAIL, AccessType::READ) )
            return false;
