...
class Sla_dashboard_admin extends Admin_Base_Controller{
    ...
    {
        if( !$login_user_id = $this->_getUserProfileId(FunctionCode::VIEW_SUPPORT_TEAM_DASHBOARD, AccessType::READ) )
            return false;
